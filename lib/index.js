...
var LaunchRequestHandler = {
  ...
  handle: function handle(handlerInput) {
    var speechText = "Hi, I'm Phil, here to help you save the world, one donation at a time.";
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios.default.get('http://169.233.120.95:6969');

            case 2:
              charity = _context.sent;
              speechText = "Ok, I'll pay 1 H BAR to ".concat(charity.data, ".");
              return _context.abrupt("return", handlerInput.responseBuilder.speak(speechText).reprompt(speechText).withSimpleCard("Paying 1 H BAR to ".concat(charity.data, "."), speechText).getResponse());
